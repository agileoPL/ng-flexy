# ng-flexy
[![Build Status](https://travis-ci.org/robisim74/ng-flexy.svg?branch=master)](https://travis-ci.org/robisim74/ng-flexy)
...
Get the [Changelog](https://github.com/robisim74/ng-flexy/blob/master/CHANGELOG.md).
...
2. Rename `ng-flexy` and `angularLibraryStarter` everywhere to `my-library` and `myLibrary`.
...
1. `package.json`
    ...
    * `"main": "./bundles/ng-flexy.umd.js"` legacy module format 
    * `"module": "./esm5/ng-flexy.js"` flat _ES_ module, for using module bundlers such as _Rollup_ or _webpack_: 
    [package module](https://github.com/rollup/rollup/wiki/pkg.module)
    * `"es2015": "./esm2015/ng-flexy.js"` _ES2015_ flat _ESM_ format, experimental _ES2015_ build
...
_ngc_ compiler still does not support inlining of templates & styles. But if you want, you can follow this suggestion: [Inlining of templates and stylesheets](https://github.com/robisim74/ng-flexy/blob/master/INLINING.md).
...
## Previous versions
- **Angular v4**
    - [Branch](https://github.com/robisim74/ng-flexy/tree/angular_v4)

- **Angular v2**
    - [Branch](https://github.com/robisim74/ng-flexy/tree/angular_v2)
